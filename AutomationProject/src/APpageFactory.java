...
import ReadExcelData.InputExcelData;
import ReadExcelData.ReadExcel2;

import excelDataLib.ExcelDataConfig;

public class APpageFactory {

	
	private Logger log = Logger.getLogger(APpageFactory.class);
	...
	public void testCase2(String userName, String PWD){
		...
		System.out.println("entered email address: " + userName);
	...
	public String createData1(){
		String UserName = ExcelDataConfig.getAllRowsUsername(0, 0);
		return UserName;
	}*/
	 ...
	 @DataProvider(name = "testdata")
	    ...
	    public Object[][] Authentication() throws Exception{
	         ...
	         Object[][] testObjArray = InputExcelData.getExcelData("C:\\Users\\sheheryar\\ExcelData\\LoginTestData.xlsx", 0);
	 
	         return (testObjArray);
	 
			}
	
	/*public ReadExcel2 Exc;
  
	@DataProvider(name = "testdata")
	    public Object[][] accountCreation() throws IOException{
	          Object[][] arrayObject= Exc.getExcelData("C:\\Users\\sheheryar\\ExcelData\\LoginTestData.xlsx", "sheet1");
	        return arrayObject;
	}*/
	}
